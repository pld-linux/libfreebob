...
Summary(pl):	FreeBoB - wolnodostêpna implementacja sterowników dla platformy BeBoB
Name:		libfreebob
Version:	1.0.0
Release:	1
License:	GPL v2+
...
%description -l pl
Celem tego projektu jest zapewnienie wolnodostêpnej implementacji
sterowników dla platformy BeBoB. BeBoB jest u¿ywana w wielu dostêpnych
"break-out boksach" opartych na IEEE 1394.

%package devel
Summary:	Header files for FreeBoB library
Summary(pl):	Pliki nag³ówkowe biblioteki FreeBoB
...
Pliki nag³ówkowe biblioteki FreeBoB.
